...
import 'package:pokedex_app/core/presentation/widget/hero.dart';
...
part 'section/pokemon_overall_detail.dart';
        ...
        body: BlocConsumer<PokemonDetailCubit, PokemonDetailState>(
          ...
          builder: (context, state) {
            if (state is GetPokemonDetailLoaded) {
              return Stack(
                children: <Widget>[
                  _BackgroundDecoration(pokemonDetail: state.data),
                  _PokemonInfoCard(pokemonDetail: state.data),
                  _PokemonOverallDetail(pokemonDetail: state.data),
                ],
              );
            }
